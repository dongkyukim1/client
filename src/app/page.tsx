        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
              ...
              <div className="space-y-10">
                ...
                <div className="transition-all duration-300 hover:shadow-md p-6 rounded-xl border border-gray-100 hover:border-pink-100">
                  <h3 className="text-xl font-bold mb-4 text-gray-800 flex items-center">
                    <svg className="h-6 w-6 text-pink-500 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="border-t border-gray-200 p-6 flex justify-between items-center bg-gray-50 rounded-b-2xl">
              ...
              <button 
                className="bg-gradient-to-r from-pink-500 to-pink-600 text-white px-8 py-3 rounded-xl hover:from-pink-600 hover:to-pink-700 shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 border-0 outline-none"
              >
                여행 계획 생성하기
              </button>
            </div>
